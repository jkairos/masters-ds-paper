...
\author{Sávio S. T. de Oliveira\inst{2}, Jose F. de S. Filho\inst{1}, Vagner J. do Sacramento Rodrigues\inst{2}, \\Marcelo de C. Cardoso\inst{2}, Sérgio T. de Carvalho\inst{1}}
...
\address{Instituto de Informática -- Universidade Federal de Goiás
  ...
  CEP 74820-270 -- Goiânia -- GO -- Brazil\\[12pt] {\tt\footnotesize savio.teles@gogeo.io, jkairos@gmail.com, vagner@gogeo.io,}\\ {\tt\footnotesize marcelo.cardoso@gogeo.io, sergio@inf.ufg.br}
  }
\begin{document} 
...
They are based on distributed indexes for an high performance processing. Researches and ongoing work use R-trees as a distributed spatial structure for indexing and retrieval of geo objects. 
