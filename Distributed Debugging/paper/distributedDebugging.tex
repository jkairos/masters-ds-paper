...
\begin{abstract}
 ...
 However none of them has addressed the debugging of a distributed R-Tree index. This paper presents a new algorithm for debugging a distributed R-Tree index, hereinafter RDebug. 
